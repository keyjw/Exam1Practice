...
def run_test_problem1a():
    ...
    # Test 3:
    expected = 0.10469  # This is APPROXIMATELY the correct answer.
    ...
    # Test 4:
    expected = -1.9938  # This is APPROXIMATELY the correct answer.
